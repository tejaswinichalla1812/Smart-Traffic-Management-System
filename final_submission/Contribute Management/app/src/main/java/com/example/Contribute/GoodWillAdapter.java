...
class GoodWillAdapter extends RecyclerView.Adapter<GoodWillAdapter.myviewholder>
{
    ...
    public GoodWillAdapter(ArrayList<model> datalist, GoodWillHomeScreen userdataActivity) {
